...
class Chooose_guests extends StatefulWidget {
  @override
  _Chooose_guestsState createState() => _Chooose_guestsState();
}

class _Chooose_guestsState extends State<Chooose_guests> {
  int _n = 0;
  int _m = 0;
  int total;
  void add() {
